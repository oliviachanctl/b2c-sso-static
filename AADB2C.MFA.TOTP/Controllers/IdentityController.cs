...
namespace AADB2C.RestoreUsername.API.Controllers
{
    ...
    public class IdentityController : Controller
    {
        ...
        public IdentityController(IOptions<AppSettingsModel> appSettings,ILogger<IdentityController> logger)
        {
        ...
        {
             _logger.LogInformation("Generate function called !");
            string input = null;
            ...
            try
            {
                ...
                //Uri myUri = new Uri(TOTPUrl);
                //string TOTPSecret = System.Web.HttpUtility.ParseQueryString(myUri.Query).Get("secret");

                B2CResponseModel output = new B2CResponseModel(string.Empty, HttpStatusCode.OK)
                {
                    TOTPUrlResponse = TOTPUrl,
        ...
        {
            _logger.LogInformation("Verify function called !");
            string input = null;
